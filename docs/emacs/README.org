...
| C-x C-o     | Deletes all blank lines between current line and |
|             | next line of text                                |
| C-M-o       | Splits the line after point indenting new line   |
|             | to position of point                             |
| M-^         | Join the line point is on with the point above   |
|             | if given an argument joins with line below.      |
|-------------+--------------------------------------------------|
